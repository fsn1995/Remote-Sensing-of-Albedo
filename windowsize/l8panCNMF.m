...
% figure;
% imshow(l8pan);
latlim = [66.5 67.5]; % so k transect
lonlim = [-50.1 -49];
...
%     band(band<0) = 0;
    [band, Rband]= readgeoraster(bands);
    img(:,:,i) = mapcrop(band, Rband, xlim, ylim);
end
...
newhcube = sharpencnmf(hcube,l8pancrop);
...
figure
montage({lrData;l8pancrop;outputData})
...
geotiffwrite(fullfile(l8folder, "LC08_L2SP_007013_20200822_20200905_02_T1.tif"), ...
    newhcube.DataCube, Rb,'CoordRefSysCode', 32622, 'TiffType','bigtiff'); 

...
# dfmerge = dfmerge.groupby(['year', 'month', 'day']).mean()
# %%
# dfmerge = pd.read_excel(r"C:\Users\au686295\Documents\GitHub\PhD\Remote-Sensing-of-Albedo\validation\tarfala\albedomerge.xlsx")
